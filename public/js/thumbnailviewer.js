...
//definefooter: '<div class="footerbar">Đóng cửa sổ X</div>', //Define HTML for footer interface
...
{ //Centers a div element on the page
	...
	*/
	...
	var topposition=(docheight>objheight)? scroll_top+docheight/2-objheight/2+"px" : scroll_top+00+"px" //Vertical position of div element: Either centered, or if element height larger than viewpoint height, 10px from top of viewpoint

	//divobj.style.left=docwidth/2-objwidth/2+"px" //Center div element horizontally
	//divobj.style.top=Math.floor(parseInt(topposition))+"px"

	divobj.style.left=Math.floor(parseInt(docwidth/2-objwidth/2) + 250)+"px" //Center div element horizontally
	divobj.style.top=Math.floor(parseInt(topposition))+"px"
...
{ //Load image function that gets attached to each link on the page with rel="thumbnail"
	...
	var imageHTML='<img src="'+link.getAttribute("name")+'" style="'+this.opacitystring+'" width=500px />' //Construct HTML for shown image
...
{ //Initialize thumbnail viewer script by scanning page and attaching appropriate function to links with rel="thumbnail"
	...
	{ //BEGIN FOR LOOP
		...
		{ //Begin if statement
			...
			//pagelinks[i].onmousemove=function()
